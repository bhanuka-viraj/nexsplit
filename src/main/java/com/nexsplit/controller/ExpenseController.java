...
public class ExpenseController {
    ...
    public ResponseEntity<ApiResponse<PaginatedResponse<ExpenseDto>>> getExpensesByUserInvolvement(
        ...
        PaginatedResponse<ExpenseDto> response = expenseService.getExpensesByUserInvolvement(userId, page, size);
    ...
    public ResponseEntity<ApiResponse<ExpenseSummaryDto>> getExpenseSummary(
        ...
        ExpenseSummaryDto summary = expenseService.getExpenseSummary(nexId, userId);
    ...
    public ResponseEntity<ApiResponse<PaginatedResponse<ExpenseDto>>> getExpensesByCategoryId(
        ...
        PaginatedResponse<ExpenseDto> response = expenseService.getExpensesByCategoryId(categoryId, userId, page, size);
    ...
    public ResponseEntity<ApiResponse<PaginatedResponse<ExpenseDto>>> getExpensesByPayerId(
        ...
        PaginatedResponse<ExpenseDto> response = expenseService.getExpensesByPayerId(payerId, userId, page, size);
